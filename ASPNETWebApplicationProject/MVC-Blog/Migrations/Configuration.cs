    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(ApplicationDbContext context)
        {
            if (!context.Users.Any())
            {
                ...
                CreateUser(context, "denislav@gmail.com", "123", "Denislav Zotev");
                CreateUser(context, "angelina@gmail.com", "123", "Angelina Gesheva");
                CreateUser(context, "misho@gmail.com", "123", "Mihail Malamov");
                CreateUser(context, "stivan@gmail.com", "123", "Stivan Georgiev");
                ...
                CreatePost(context,
                    title: "Early Modern Texts", body: @"<p>On this site you will find versions of some classics of early modern philosophy, and a few from the 19th century, prepared with a view to making them easier to read while leaving intact the main arguments, doctrines, and lines of thought.</p>",
                    date: new DateTime(2016, 06, 30, 17, 36, 52),
                    authorUsername: "merry@gmail.com"
                );

                CreatePost(context,
                    title: "News July 2015", body: @"<p>We apologise for the recent downtime to the site. It happened that the appointed time to transfer ownership of the domain name from Jonathan to Peter and Amyas coincided with the premature birth of Amyas’s first child.</p>
                    <p> As a result, things did not go quite as smoothly as we had hoped. Mother and daughter are both well, and the site should now be enjoying uninterrupted service once again.</p>",
                    date: new DateTime(2016, 06, 30, 17, 36, 52),
                    authorUsername: "merry@gmail.com"
                );

                CreatePost(context,
                    title: "Simple Programming Problems", body: @"<p>Whenever I’m TA for a introductory CS class where students learn some programming language, I have trouble coming up with good exercises.</p>
                    <p>Problems from Project Euler and the like are usually much too difficult for beginners, especially if they don’t have a strong background in mathematics</p>
                    <p>This page is a collection of progressively more difficult exercises that are suitable for people who just started learning. It will be extended as I come up with new exercises.</p>
                    <p>Except for the GUI questions, exercises are generally algorithmic and should be solvable without learning any libraries.</p>
                    <p>The difficulty of the exercises of course somewhat depends on the programming language you use. The List exercises for example are more complicated in languages like C that don’t have build-in support for lists.</p>",
                    date: new DateTime(2016, 06, 30, 17, 36, 52),
                    authorUsername: "merry@gmail.com"
                );
